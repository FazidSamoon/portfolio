...
function Header() {
  ...
  return (
    <div id='header-container' className={`${show ? 'bg-red-500 ' : 'bg-none '} mobile:hidden tablet:flex desktop:flex w-screen h-16 z-20 laptop:flex items-center justify-center fixed transition ease-in duration-300 drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]'`}>
